...
if(NOT TARGET standalone_absl)
  ...
  ExternalProject_Add(${ABSEIL_PROJECT_NAME}
    ...
    CMAKE_ARGS       "-DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=True;-DCMAKE_C_COMPILER=${CMAKE_C_COMPILER};-DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}"
    CMAKE_CACHE_ARGS "-DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=True;-DBUILD_TESTING:BOOL=OFF;-DCMAKE_BUILD_TYPE:STRING=Release"
